    ...
    return (
        <div className="payment-container">
            ...
            <div className="payment-card">
                ...
                <a href="https://buy.stripe.com/test_28odSngqI3Z56HuaEF" target="_blank">
            ...
            <div className="payment-card" >
                ...
                <a href='https://buy.stripe.com/test_5kAg0v1vO8flc1OaEE' target="_blank">
                <button onClick={handlePayment} className="pay-button">Pay Now</button>
                </a>
            ...
            <div className="payment-card" >
                ...
                <a href='https://buy.stripe.com/test_3cs7tZ5M4gLR8PC8wy' target="_blank">
                <button onClick={handlePayment} className="pay-button">Pay Now</button>
                </a>
            </div>
            </div>
